...
interface LanguageContributionSectionProps {
  languageContributions: LanguageContribution[];
}
...
interface RepositoryPerformanceSectionProps {
  repositoryPerformanceData: ReturnType<typeof buildRepositoryPerformanceData>;
}

const UserHeroSection: React.FC<UserHeroSectionProps> = ({ user, advancedStats }) => (
...
const ProfileHighlights: React.FC<ProfileHighlightsProps> = ({ user, advancedStats }) => (
...
const LanguageContributionSection: React.FC<LanguageContributionSectionProps> = ({ languageContributions }) => (
  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
    <h3 className="text-xl font-semibold text-white mb-6 flex items-center">
...
const ActivitySection: React.FC<ActivitySectionProps> = ({ activityData }) => (
  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
    <h3 className="text-xl font-semibold text-white mb-6 flex items-center">
...
const RepositoryPerformanceSection: React.FC<RepositoryPerformanceSectionProps> = ({ repositoryPerformanceData }) => (
  <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
    <h3 className="text-xl font-semibold text-white mb-6 flex items-center">
...
const UserProfileContent: React.FC<UserProfileContentProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <UserHeroSection user={user} advancedStats={advancedStats} />
      <ProfileHighlights user={user} advancedStats={advancedStats} />
      <AchievementsSection achievements={achievements} />

      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <LanguageContributionSection languageContributions={languageContributions} />
        <ActivitySection activityData={activityData} />
        <RepositoryPerformanceSection repositoryPerformanceData={repositoryPerformanceData} />
      </div>
    </div>
  );
};
